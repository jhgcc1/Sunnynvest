    ...
    for SimulationYear in range(0,objIpunt["sim_year"]):
        ...
        for simNum in range(0,len(rd_distRad)):
            ...
            if SimulationYearString not in simMC_result:
                simMC_result[SimulationYearString]={"inputs":{"priceinverters":{"mean":0,"std":0,"rawData":[]},"pricepanel":{"mean":0,"std":0,"rawData":[]},"Maintenance":{"mean":0,"std":0,"rawData":[]},"Cost of debit":{"mean":0,"std":0,"rawData":[]},"Irradiation":{"mean":0,"std":0,"rawData":[]},"Cost of equity":{"mean":0,"std":0,"rawData":[]},"Inverters lifespan":{"mean":0,"std":0,"rawData":[]},"Panels lifespan":{"mean":0,"std":0,"rawData":[]}},"outputs":{"Price per KWp":{"mean":0,"std":0,"rawData":[]},"Simple payback":{"mean":0,"std":0,"rawData":[]},"Total investment":{"mean":0,"std":0,"rawData":[]},"IRR":{"mean":0,"std":0,"rawData":[]},"NPV":{"mean":0,"std":0,"rawData":[]},"MIRR":{"mean":0,"std":0,"rawData":[]},"Equivalent annual annuity":{"mean":0,"std":0,"rawData":[]},"Cost/kwh":{"mean":0,"std":0,"rawData":[]},"LCOE":{"mean":0,"std":0,"rawData":[]},"Future value (IRR inflated rate)":{"mean":0,"std":0,"rawData":[]},"Future value (MIRR inflated rate)":{"mean":0,"std":0,"rawData":[]},"Future value (IRR Non-inflated rate)":{"mean":0,"std":0,"rawData":[]},"Future value (MIRR Non-inflated rate)":{"mean":0,"std":0,"rawData":[]},"Discounted payback":{"rawData":[]}}}
